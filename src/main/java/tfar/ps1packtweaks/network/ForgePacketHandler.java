...
import tfar.ps1packtweaks.network.client.S2CModPacket;
import tfar.ps1packtweaks.network.server.C2SModPacket;
...
public class ForgePacketHandler {
    ...
    public static SimpleChannel INSTANCE =  NetworkRegistry.newSimpleChannel(PS1PackTweaks.id("packet"), () -> "1.0", s -> true, s -> true);
